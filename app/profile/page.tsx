  ...
  return (
    <div className="min-h-screen bg-[#FAF7F2] text-[#2B261F] font-[system-ui]">
      <div className="max-w-2xl mx-auto px-4 pt-8 pb-28">
        <p className="text-xs uppercase tracking-[0.2em] text-[#A39C8C] mb-1">Settings</p>
        ...
        {loading ? (
          ...
          <form onSubmit={save} className="bg-[#FFFFFF] border border-[#E2DCD0] rounded-2xl p-5 space-y-4">
            <div>
              ...
              <div className="mb-3">
                <label className="block text-xs text-[#6B6357] mb-1">Experience level</label>
                <select
              ...
              <div className="mb-3">
                <label className="block text-xs text-[#6B6357] mb-1">Injury history (optional)</label>
                <textarea
                  value={injuryHistory}
                  onChange={(e) => setInjuryHistory(e.target.value)}
                  placeholder="e.g. recurring left knee IT band issues, avoid high mileage weeks"
                  rows={2}
                  className="w-full bg-[#FFFFFF] border border-[#E2DCD0] rounded-xl px-3 py-2 text-sm outline-none shadow-sm focus:border-[#2E9C86] focus:shadow-md transition-shadow resize-y"
                />
              </div>

              <div className="mb-3">
                <label className="block text-xs text-[#6B6357] mb-2">Preferred training days (optional)</label>
              ...
              <div className="mb-3">
                <label className="block text-xs text-[#6B6357] mb-1">Max weekly training hours (optional)</label>
                <input
                  type="number"
                  min="0"
                  step="0.5"
              ...
              <div className="mb-3">
                <label className="block text-xs text-[#6B6357] mb-2">Cross-training preferences (optional)</label>
                <div className="flex flex-wrap gap-2">
                ...
                <p className="text-[10px] text-[#A39C8C] mt-1">
                  Default selection on the goal/maintenance-plan forms — still overridable per generation.
                </p>
              </div>

              <div>
                <label className="block text-xs text-[#6B6357] mb-1">Notes</label>
                <textarea
                  value={notes}
            ...
            <div className="pt-2 border-t border-[#E2DCD0]">
              ...
              <div className="space-y-2">
                <label className="flex items-start gap-2 text-sm cursor-pointer">
                  ...
                  <span>
                    ...
                    <span className="block text-xs text-[#A39C8C]">
            ...
            <div className="flex gap-3">
              <div className="flex-1">
                <label className="block text-xs text-[#6B6357] mb-1">Max HR (bpm)</label>
                <input
                  type="number"
                  min="0"
                  value={maxHr}
              ...
              <div className="flex-1">
                <label className="block text-xs text-[#6B6357] mb-1">Resting HR (bpm)</label>
                <input
                  type="number"
                  min="0"
                  value={restingHr}
            ...
            {hrMethodUnavailable && (
              <p className="text-xs text-[#D98A3D]">
            ...
            {message && <p className="text-xs text-[#2E9C86]">{message}</p>}

            <button
              type="submit"
              disabled={saving}
              className="text-sm px-3 py-2 rounded-xl bg-[#5FC2AB] text-[#FAF7F2] shadow-md shadow-[#5FC2AB]/25 font-medium disabled:opacity-50"
            >
        ...
        <div className="pt-6 mt-6 border-t border-[#E2DCD0]">
          <button
            type="button"
            onClick={handleLogout}
            className="text-sm px-3 py-2 rounded-xl border border-[#D9D2C4] text-[#6B6357] hover:bg-[#EFE9DE]"
          >
            Log out
          </button>
        </div>
